...
def _instruction_line_for_observation(observation: str, default_final: str = "Please reason step by step, and put your final response within \\boxed{}.", default_message: str = "This is a conversation turn, not a decision turn. Please reason step by step, and put your broadcast message to all other players within \\boxed{}.") -> str:
...
TEMPLATE_PARTS = {
    ...
    "qwen3-custom-generic-conversation-turn": {
        "user": lambda obs: f"<|im_start|>user\n{obs}\nThis is a conversation turn, not a decision turn. Please reason step by step, and put your broadcast message to all other players within \\boxed{{}}.<|im_end|>\n",
        "assistant": "<|im_start|>assistant\n"
    },
